/**
 * Generates the reference test vectors for the ERC-8257 Tool Registry spec.
 *
 * Produces:
...
function showMatchingToolConfig(args: {
  ...
  console.log(
    `- Canonical CAIP-19 tool reference: \`${args.registryChain}/erc8257:${args.registryAddr}/${args.toolId}\``,
  )
}
